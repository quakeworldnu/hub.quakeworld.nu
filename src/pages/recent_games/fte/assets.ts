...
function getGeneralAssets(): object {
  const filePaths = [
    ...
    "id1/textures/bmodels/+0_med100.png",
    "id1/textures/bmodels/+0_med25_luma.png",
    "id1/textures/bmodels/+0_med25.png",
    "id1/textures/bmodels/+0_med25s.png",
    "id1/textures/bmodels/+1_med100.png",
    "id1/textures/bmodels/+1_med25_luma.png",
    "id1/textures/bmodels/+1_med25.png",
    "id1/textures/bmodels/+1_med25s.png",
    "id1/textures/bmodels/+2_med100.png",
    "id1/textures/bmodels/+2_med25_luma.png",
    "id1/textures/bmodels/+2_med25.png",
    "id1/textures/bmodels/+2_med25s.png",
    "id1/textures/bmodels/+3_med100.png",
    "id1/textures/bmodels/+3_med25_luma.png",
    "id1/textures/bmodels/+3_med25.png",
    "id1/textures/bmodels/+3_med25s.png",
    "id1/textures/bmodels/batt0sid.png",
    "id1/textures/bmodels/batt0top.png",
    "id1/textures/bmodels/batt1sid.png",
    "id1/textures/bmodels/batt1top.png",
    "id1/textures/bmodels/med100.png",
    "id1/textures/bmodels/med3_0_luma.png",
    "id1/textures/bmodels/med3_0.png",
    "id1/textures/bmodels/med3_1.png",
    "id1/textures/bmodels/nail0sid.png",
    "id1/textures/bmodels/nail0top.png",
    "id1/textures/bmodels/nail1sid.png",
    "id1/textures/bmodels/nail1top_luma.png",
    "id1/textures/bmodels/nail1top.png",
    "id1/textures/bmodels/rock0sid.png",
    "id1/textures/bmodels/rock1sid.png",
    "id1/textures/bmodels/rockettop.png",
    "id1/textures/bmodels/shot0sid.png",
    "id1/textures/bmodels/shot0top.png",
    "id1/textures/bmodels/shot1sid.png",
    "id1/textures/bmodels/shot1top_luma.png",
    "id1/textures/bmodels/shot1top.png",
    "id1/textures/charsets/graybugs.png",
    ...
    "id1/textures/wad/anum_0.png",
    "id1/textures/wad/anum_1.png",
    "id1/textures/wad/anum_2.png",
    "id1/textures/wad/anum_3.png",
    "id1/textures/wad/anum_4.png",
    "id1/textures/wad/anum_5.png",
    "id1/textures/wad/anum_6.png",
    "id1/textures/wad/anum_7.png",
    "id1/textures/wad/anum_8.png",
    "id1/textures/wad/anum_9.png",
    "id1/textures/wad/anum_colon.png",
    "id1/textures/wad/anum_minus.png",
    "id1/textures/wad/face1.png",
    "id1/textures/wad/face2.png",
    "id1/textures/wad/face3.png",
    "id1/textures/wad/face4.png",
    "id1/textures/wad/face5.png",
    "id1/textures/wad/face_inv2.png",
    "id1/textures/wad/face_invis.png",
    "id1/textures/wad/face_invul1.png",
    "id1/textures/wad/face_invul2.png",
    "id1/textures/wad/face_p1.png",
    "id1/textures/wad/face_p2.png",
    "id1/textures/wad/face_p3.png",
    "id1/textures/wad/face_p4.png",
    "id1/textures/wad/face_p5.png",
    "id1/textures/wad/face_quad.png",
    "id1/textures/wad/ibar.png",
    "id1/textures/wad/inv2_lightng.png",
    "id1/textures/wad/inv2_nailgun.png",
    "id1/textures/wad/inv2_rlaunch.png",
    "id1/textures/wad/inv2_shotgun.png",
    "id1/textures/wad/inv2_snailgun.png",
    "id1/textures/wad/inv2_srlaunch.png",
    "id1/textures/wad/inv2_sshotgun.png",
    "id1/textures/wad/inva1_lightng.png",
    "id1/textures/wad/inva1_nailgun.png",
    "id1/textures/wad/inva1_rlaunch.png",
    "id1/textures/wad/inva1_shotgun.png",
    "id1/textures/wad/inva1_snailgun.png",
    "id1/textures/wad/inva1_srlaunch.png",
    "id1/textures/wad/inva1_sshotgun.png",
    "id1/textures/wad/inva2_lightng.png",
    "id1/textures/wad/inva2_nailgun.png",
    "id1/textures/wad/inva2_rlaunch.png",
    "id1/textures/wad/inva2_shotgun.png",
    "id1/textures/wad/inva2_snailgun.png",
    "id1/textures/wad/inva2_srlaunch.png",
    "id1/textures/wad/inva2_sshotgun.png",
    "id1/textures/wad/inva3_lightng.png",
    "id1/textures/wad/inva3_nailgun.png",
    "id1/textures/wad/inva3_rlaunch.png",
    "id1/textures/wad/inva3_shotgun.png",
    "id1/textures/wad/inva3_snailgun.png",
    "id1/textures/wad/inva3_srlaunch.png",
    "id1/textures/wad/inva3_sshotgun.png",
    "id1/textures/wad/inva4_lightng.png",
    "id1/textures/wad/inva4_nailgun.png",
    "id1/textures/wad/inva4_rlaunch.png",
    "id1/textures/wad/inva4_shotgun.png",
    "id1/textures/wad/inva4_snailgun.png",
    "id1/textures/wad/inva4_srlaunch.png",
    "id1/textures/wad/inva4_sshotgun.png",
    "id1/textures/wad/inva5_lightng.png",
    "id1/textures/wad/inva5_nailgun.png",
    "id1/textures/wad/inva5_rlaunch.png",
    "id1/textures/wad/inva5_shotgun.png",
    "id1/textures/wad/inva5_snailgun.png",
    "id1/textures/wad/inva5_srlaunch.png",
    "id1/textures/wad/inva5_sshotgun.png",
    "id1/textures/wad/inv_lightng.png",
    "id1/textures/wad/inv_nailgun.png",
    "id1/textures/wad/inv_nails.png",
    "id1/textures/wad/inv_rlaunch.png",
    "id1/textures/wad/inv_rocket.png",
    "id1/textures/wad/inv_shells.png",
    "id1/textures/wad/inv_shotgun.png",
    "id1/textures/wad/inv_snailgun.png",
    "id1/textures/wad/inv_srlaunch.png",
    "id1/textures/wad/inv_sshotgun.png",
    "id1/textures/wad/num_0.png",
    "id1/textures/wad/num_1.png",
    "id1/textures/wad/num_2.png",
    "id1/textures/wad/num_3.png",
    "id1/textures/wad/num_4.png",
    "id1/textures/wad/num_5.png",
    "id1/textures/wad/num_6.png",
    "id1/textures/wad/num_7.png",
    "id1/textures/wad/num_8.png",
    "id1/textures/wad/num_9.png",
    "id1/textures/wad/num_colon.png",
    "id1/textures/wad/num_minus.png",
    ...
    "id1/textures/wad/sb_armor1.png",
    "id1/textures/wad/sb_armor2.png",
    "id1/textures/wad/sb_armor3.png",
    "id1/textures/wad/sb_cells.png",
    "id1/textures/wad/sb_invis.png",
    "id1/textures/wad/sb_invuln.png",
    "id1/textures/wad/sb_key1.png",
    "id1/textures/wad/sb_key2.png",
    "id1/textures/wad/sb_nails.png",
    "id1/textures/wad/sb_quad.png",
    "id1/textures/wad/sb_rocket.png",
    "id1/textures/wad/sb_shells.png",
    "id1/textures/wad/sb_sigil1.png",
    "id1/textures/wad/sb_sigil2.png",
    "id1/textures/wad/sb_sigil3.png",
    "id1/textures/wad/sb_sigil4.png",
  ...
  for (const path of filePaths) {
    assets[path] = `${FTE_ASSETS_URL}/${path}`;
  }
