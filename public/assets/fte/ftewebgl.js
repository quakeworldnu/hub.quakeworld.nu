...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    Module["asm"] = exports;
    wasmMemory = Module["asm"]["Ic"];
    updateGlobalBufferAndViews(wasmMemory.buffer);
    wasmTable = Module["asm"]["Kc"];
    addOnInit(Module["asm"]["Jc"]);
...
function _Sys_Clipboard_PasteText(cbt, callback, ctx) {
  ...
  let docallback = function (text) {
    ...
    try {
      ...
      (function (cb, a1, a2) {
        getWasmTableEntry(cb)(a1, a2);
      })(callback, ctx, dataptr);
      _free(dataptr);
    } catch (e) {}
  };
  try {
...
function _emscriptenfte_async_wget_data2(
  ...
  http.onload = function (e) {
    if (http.status == 200) {
      if (onload)
        (function (cb, a1, a2) {
          getWasmTableEntry(cb)(a1, a2);
        })(onload, ctx, _emscriptenfte_buf_createfromarraybuf(http.response));
    } else {
      if (onerror)
        (function (cb, a1, a2) {
          getWasmTableEntry(cb)(a1, a2);
        })(onerror, ctx, http.status);
    }
  };
  ...
  http.onprogress = function (e) {
    if (onprogress)
      (function (cb, a1, a2, a3) {
        getWasmTableEntry(cb)(a1, a2, a3);
      })(onprogress, ctx, e.loaded, e.total);
  };
  try {
    http.send(null);
  } catch (e) {
      ...
      for (var j = 0; j < gp.buttons.length; j += 1) {
        ...
        if (b.lastframe != p) {
          ...
          (function (cb, a1, a2, a3, a4) {
            getWasmTableEntry(cb)(a1, a2, a3, a4);
          })(FTEC.evcb.jbutton, gp.index, j, p, gp.mapping == "standard");
        }
      }
      for (var j = 0; j < gp.axes.length; j += 1)
        (function (cb, a1, a2, a3, a4) {
          getWasmTableEntry(cb)(a1, a2, a3, a4);
        })(FTEC.evcb.jaxis, gp.index, j, gp.axes[j], gp.mapping == "standard");
    }
}
...
function _emscriptenfte_rtc_candidate(sockid, offer) {
  ...
  try {
    var desc;
    if (1) desc = JSON.parse(offer);
    else desc = { candidate: offer, sdpMid: null, sdpMLineIndex: 0 };
...
function _emscriptenfte_rtc_create(clientside, ctxp, ctxi, callback) {
  ...
  var s = {
    ...
    callcb: function (evtype, stringdata) {
      ...
      (function (cb, a1, a2, a3, a4) {
        getWasmTableEntry(cb)(a1, a2, a3, a4);
      })(callback, ctxp, ctxi, evtype, dataptr);
      _free(dataptr);
    },
  };
...
function _emscriptenfte_rtc_offer(sockid, offer, offertype) {
  ...
  try {
    if (1) desc = JSON.parse(offer);
    else desc = { sdp: offer, type: offertype };
...
var FTEC = {
  ...
  loadurl: function (url, mime, arraybuf) {
    if (FTEC.evcb.loadfile != 0) {
      ...
      (function (cb, a1, a2, a3) {
        getWasmTableEntry(cb)(a1, a2, a3);
      })(FTEC.evcb.loadfile, urlptr, mimeptr, handle);
      _free(mimeptr);
      _free(urlptr);
      window.focus();
    }
  ...
  cbufadd: function (command) {
    if (FTEC.evcb.cbufaddtext != 0) {
      ...
      (function (cb, a1) {
        getWasmTableEntry(cb)(a1);
      })(FTEC.evcb.cbufaddtext, ptr);
      _free(ptr);
      window.focus();
    }
  },
  step: function (timestamp) {
    ...
    try {
      dovsync = (function (cb, a1) {
        return getWasmTableEntry(cb)(a1);
      })(FTEC.evcb.frame, timestamp);
    } catch (err) {
      console.log(err);
    }
    ...
    switch (event.type) {
      ...
      case "resize":
        if (FTEC.evcb.resize != 0) {
          (function (cb, a1, a2) {
            getWasmTableEntry(cb)(a1, a2);
          })(FTEC.evcb.resize, Module["canvas"].width, Module["canvas"].height);
        }
        break;
      case "mousewheel":
      case "wheel":
        if (FTEC.evcb.button != 0) {
          (function (cb, a1, a2, a3) {
            getWasmTableEntry(cb)(a1, a2, a3);
          })(FTEC.evcb.button, 0, 2, event.deltaY);
      ...
      case "blur":
        (function (cb, a1, a2, a3, a4) {
          return getWasmTableEntry(cb)(a1, a2, a3, a4);
        })(FTEC.evcb.key, 0, false, 16, 0);
        (function (cb, a1, a2, a3, a4) {
          return getWasmTableEntry(cb)(a1, a2, a3, a4);
        })(FTEC.evcb.key, 0, false, 17, 0);
        (function (cb, a1, a2, a3, a4) {
          return getWasmTableEntry(cb)(a1, a2, a3, a4);
        })(FTEC.evcb.key, 0, false, 18, 0);
      ...
      case "keypress":
        if (FTEC.evcb.key != 0) {
          ...
          (function (cb, a1, a2, a3, a4) {
            return getWasmTableEntry(cb)(a1, a2, a3, a4);
          })(FTEC.evcb.key, 0, 1, 0, event.charCode);
          (function (cb, a1, a2, a3, a4) {
            return getWasmTableEntry(cb)(a1, a2, a3, a4);
          })(FTEC.evcb.key, 0, 0, 0, event.charCode);
          event.preventDefault();
          event.stopPropagation();
        }
        break;
      ...
      case "keyup":
        if (FTEC.evcb.key != 0 && event.keyCode != 122) {
          if (
            (function (cb, a1, a2, a3, a4) {
              return getWasmTableEntry(cb)(a1, a2, a3, a4);
            })(FTEC.evcb.key, 0, event.type == "keydown", event.keyCode, 0)
          )
            event.preventDefault();
        }
        break;
...
var asmLibraryArg = {
  ...
  ic: __embind_register_void,
  oa: __emscripten_date_now,
  qc: __emval_call_void_method,
  vc: __emval_decref,
  pc: __emval_get_method_caller,
  hb: __emval_incref,
  rc: __emval_new_array,
  uc: __emval_new_cstring,
  xc: __emval_new_object,
  wc: __emval_set_property,
  ya: __emval_take_value,
  Lb: __gmtime_js,
  Mb: __localtime_js,
  Nb: __mktime_js,
  Ob: __tzset_js,
  ...
  X: _alGetString,
  nc: _alIsBuffer,
  cb: _alIsExtensionPresent,
  $a: _alIsSource,
  oc: _alListenerf,
  W: _alListenerfv,
  ab: _alSourcePlay,
  V: _alSourceQueueBuffers,
  _a: _alSourceStop,
  bb: _alSourceUnqueueBuffers,
  n: _alSourcef,
  Za: _alSourcefv,
  w: _alSourcei,
  Zb: _alcCaptureCloseDevice,
  _b: _alcCaptureOpenDevice,
  Wb: _alcCaptureSamples,
  Yb: _alcCaptureStart,
  Xb: _alcCaptureStop,
  ta: _alcCloseDevice,
  db: _alcCreateContext,
  gb: _alcDestroyContext,
  bc: _alcGetContextsDevice,
  cc: _alcGetCurrentContext,
  $b: _alcGetEnumValue,
  ac: _alcGetError,
  sa: _alcGetIntegerv,
  B: _alcGetString,
  ...
  fb: _alcOpenDevice,
  ec: _alcProcessContext,
  dc: _alcSuspendContext,
  Vb: _emscripten_alcDevicePauseSOFT,
  Ub: _emscripten_alcDeviceResumeSOFT,
  Tb: _emscripten_alcGetStringiSOFT,
  Rb: _emscripten_alcResetDeviceSOFT,
  fc: _emscripten_asm_const_int,
  Qb: _emscripten_console_error,
  Wa: _emscripten_get_now,
  Pb: _emscripten_memcpy_big,
  Hb: _emscripten_resize_heap,
  jc: _emscripten_run_script_string,
  P: _emscriptenfte_abortmainloop,
  lc: _emscriptenfte_al_loadaudiofile,
  mb: _emscriptenfte_alert,
  nb: _emscriptenfte_async_wget_data2,
  Z: _emscriptenfte_buf_create,
  jb: _emscriptenfte_buf_delete,
  Ac: _emscriptenfte_buf_getsize,
  zc: _emscriptenfte_buf_open,
  yc: _emscriptenfte_buf_pushtolocalstore,
  Cc: _emscriptenfte_buf_read,
  Dc: _emscriptenfte_buf_release,
  Gc: _emscriptenfte_buf_rename,
  Bc: _emscriptenfte_buf_write,
  Sb: _emscriptenfte_gl_loadtexturefile,
  ob: _emscriptenfte_polljoyevents,
  lb: _emscriptenfte_print,
  za: _emscriptenfte_rtc_candidate,
  Ba: _emscriptenfte_rtc_create,
  Aa: _emscriptenfte_rtc_offer,
  Da: _emscriptenfte_setupcanvas,
  Ec: _emscriptenfte_setupmainloop,
  pb: _emscriptenfte_updatepointerlock,
  kb: _emscriptenfte_uptime_ms,
  C: _emscriptenfte_ws_close,
  Ca: _emscriptenfte_ws_connect,
  _: _emscriptenfte_ws_recv,
  J: _emscriptenfte_ws_send,
  Fc: _emscritenfte_buf_enumerate,
  Ib: _environ_get,
  ...
  Sa: _glColorMask,
  qb: _glCompileShader,
  na: _glCompressedTexImage2D,
  Ta: _glCompressedTexSubImage2D,
  ca: _glCopyTexImage2D,
  wb: _glCopyTexSubImage2D,
  ub: _glCreateProgram,
  rb: _glCreateShader,
  Pa: _glCullFace,
  I: _glDeleteBuffers,
  Na: _glDeleteFramebuffers,
  Ia: _glDeleteProgram,
  ...
  Ab: _glGenRenderbuffers,
  q: _glGenTextures,
  ma: _glGenerateMipmap,
  Ea: _glGetAttribLocation,
  ha: _glGetError,
  l: _glGetIntegerv,
  sb: _glGetProgramInfoLog,
  aa: _glGetProgramiv,
  Ga: _glGetShaderInfoLog,
  Fa: _glGetShaderSource,
  Ha: _glGetShaderiv,
  K: _glGetString,
  ...
  ka: _glPolygonOffset,
  O: _glReadPixels,
  Ma: _glRenderbufferStorage,
  Bb: _glScissor,
  $: _glShaderSource,
  da: _glStencilFunc,
  ba: _glStencilOpSeparate,
  m: _glTexImage2D,
  la: _glTexParameterf,
  a: _glTexParameteri,
  G: _glTexSubImage2D,
...
var _malloc = (Module["_malloc"] = function () {
  return (_malloc = Module["_malloc"] = Module["asm"]["Mc"]).apply(
    null,
    arguments,
  );
});
...
var _emscripten_builtin_malloc = (Module["_emscripten_builtin_malloc"] =
  function () {
    return (_emscripten_builtin_malloc = Module["_emscripten_builtin_malloc"] =
      Module["asm"]["Qc"]).apply(null, arguments);
  });
var _emscripten_builtin_free = (Module["_emscripten_builtin_free"] =
  function () {
    return (_emscripten_builtin_free = Module["_emscripten_builtin_free"] =
      Module["asm"]["Rc"]).apply(null, arguments);
  });
var stackAlloc = (Module["stackAlloc"] = function () {
  return (stackAlloc = Module["stackAlloc"] = Module["asm"]["Sc"]).apply(
    null,
    arguments,
  );
});
var dynCall_jj = (Module["dynCall_jj"] = function () {
  return (dynCall_jj = Module["dynCall_jj"] = Module["asm"]["Tc"]).apply(
    null,
    arguments,
  );
});
var dynCall_jiji = (Module["dynCall_jiji"] = function () {
  return (dynCall_jiji = Module["dynCall_jiji"] = Module["asm"]["Uc"]).apply(
    null,
    arguments,
  );
});
